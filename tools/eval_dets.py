...
def evaluate(params):
    ...
    loader = DetsLoader(
        data_h5=data_h5, data_json=data_json, dets_json=dets_json)
    ...
    crit = None
    acc, predictions = eval_utils.eval_split(
...
if __name__ == '__main__':
    ...
    parser.add_argument('--verbose', type=int, default=1,
                        help='if we want to print the testing progress')
