...
def main(args):
    ...
    with torch.no_grad():
        for i, image_id in enumerate(image_to_dets.keys()):
            ...
            img_path = osp.join(IMAGE_DIR, 'COCO_train2014_' +
            ...
            labels = [mrcn.imdb._class_to_ind[det['category_name']]
                      for det in dets]
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--dets_file_name', default='res101_coco_minus_refer_notime_dets.json', type=str)
